		...
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle">
				<div class="auth-box ">
					...
					<div class="right">
						<div class="<?php if(!$this->session->flashdata('notifg')):?>overlay<?php else:?>overlay-danger<?php endif;?>"></div>
						<div class="content text">
							<?php if($this->session->flashdata('notifg')):?>
								<h1 class="heading"> <?php echo $this->session->flashdata('notifg'); ?></h1>
							<?php endif;?>
						</div>
					</div>
