                        ...
                        <?php foreach($disposisi as $mail):?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo base_url('index.php');?>/surat/accept_surat_disposisi/<?php echo $mail->id_mail?>" class="btn btn-success btn-sm" <?php if($mail->status != 'pending'):?> disabled <?php endif;?>>
                                            <i class="fa fa-check fa-lg"></i>
                                    </a>


                                    <a href="<?php echo base_url('index.php');?>/surat/reject_surat_disposisi/<?php echo $mail->id_mail?>" class="btn btn-danger btn-sm" <?php if($mail->status != 'pending'):?> disabled <?php endif;?>><i class="fa fa-remove fa-lg"></i></a>
                                    ...
                                    <a href="<?php echo base_url('index.php');?>/surat/delete_disposition_masuk/<?php echo $mail->id_mail;?>" class="btn btn-danger btn-sm"><i class="fa fa-trash fa-lg"></i></a>
                                </td>
                            </tr>
                        <?php $no++;?>
                        <?php endforeach;?>
